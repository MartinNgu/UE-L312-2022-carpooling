...
class ReservationsService
{
    ...
    public function setReservation(?string $id, string $author, string $client, string $rescitystart, string $rescityend, string $dateres): bool
    {
        ...
        if (empty($id)) {
            $isOk = $dataBaseService->createUser($author, $client, $rescitystart, $rescityend, $dateres);
        } else {
            $isOk = $dataBaseService->updateUser($id, $author, $client, $rescitystart, $rescityend, $dateres);
        }
